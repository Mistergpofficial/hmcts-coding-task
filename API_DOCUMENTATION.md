...
```json
{
  "title": "Write case summary",
  "description": "Put together a short summary for the case review meeting",
  "status": "pending",
...
[
  ...
  },
  {
    ...
    "description": "Go through the documents and check for missing items"
  }
]
```
...
```json
{
  ...
  "description": "Added more detail after checking the latest documents",
  "status": "in_progress",
